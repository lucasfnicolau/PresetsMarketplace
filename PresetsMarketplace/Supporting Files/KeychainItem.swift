...
struct KeychainItem {
    ...
    static var currentUserIdentifier: String {
        do {
            let storedIdentifier = try KeychainItem(service: KeychainInfo.service, account: KeychainInfo.account).readItem()
    ...
    static func deleteUserIdentifierFromKeychain() {
        do {
            try KeychainItem(service: KeychainInfo.service, account: KeychainInfo.account).deleteItem()
        } catch {
